...
import com.chaoqwq.gbt32960.modle.*;
import com.chaoqwq.gbt32960.modle.Alarm;
import com.chaoqwq.gbt32960.modle.ChargeableSubsystemElectric;
import com.chaoqwq.gbt32960.modle.ChargeableSubsystemTemperature;
import com.chaoqwq.gbt32960.modle.Engine;
import com.chaoqwq.gbt32960.modle.Extremum;
import com.chaoqwq.gbt32960.modle.FuelCell;
...
public class FormatterToDataUnit {
    ...
    public static DataUnit RealTimeReportToDataUnit(List<Object> source, Map<String, List<Object>> mapList) {
        ...
        mapList.forEach((k, v) -> {
            if (k.equals(CSE)) {
                ...
                v.forEach(cse -> list.add(toCSE((com.chaoqwq.gbt32960.message.ChargeableSubsystemElectric) cse)));
                dataUnit.setChargeableSubsystemElectricsList(list);
            }
            if (k.equals(CST)) {
                List<ChargeableSubsystemTemperature> list = new ArrayList<>();
                v.forEach(cst -> list.add(toCST((com.chaoqwq.gbt32960.message.ChargeableSubsystemTemperature) cst)));
        ...
        source.forEach(s -> {
            ...
            if (s instanceof com.chaoqwq.gbt32960.message.Extremum) {
                com.chaoqwq.gbt32960.message.Extremum extremum = (com.chaoqwq.gbt32960.message.Extremum) s;
                dataUnit.setExtremum(toExtremum(extremum));
            }
            if (s instanceof com.chaoqwq.gbt32960.message.Engine) {
                com.chaoqwq.gbt32960.message.Engine engine = (com.chaoqwq.gbt32960.message.Engine) s;
                dataUnit.setEngine(toEngine(engine));
            }
            if (s instanceof com.chaoqwq.gbt32960.message.Alarm) {
                com.chaoqwq.gbt32960.message.Alarm alarm = (com.chaoqwq.gbt32960.message.Alarm) s;
                dataUnit.setAlarm(toAlarm(alarm));
            }
            if (s instanceof com.chaoqwq.gbt32960.message.VehicleState) {
                VehicleState vehicleState = (VehicleState) s;
                dataUnit.setVehicle(toVehicle(vehicleState));
            }
            if (s instanceof com.chaoqwq.gbt32960.message.VehicleLocation) {
                VehicleLocation vehicleLocation = (VehicleLocation) s;
                dataUnit.setLocation(toLocation(vehicleLocation));
            }
            if (s instanceof com.chaoqwq.gbt32960.message.FuelCell) {
                com.chaoqwq.gbt32960.message.FuelCell fuelCell = (com.chaoqwq.gbt32960.message.FuelCell) s;
    ...
    public static ChargeableSubsystemTemperature toCST(com.chaoqwq.gbt32960.message.ChargeableSubsystemTemperature source) {
    ...
    public static ChargeableSubsystemElectric toCSE(com.chaoqwq.gbt32960.message.ChargeableSubsystemElectric source) {
    ...
    public static Alarm toAlarm(com.chaoqwq.gbt32960.message.Alarm source) {
    ...
    public static Extremum toExtremum(com.chaoqwq.gbt32960.message.Extremum source) {
    ...
    public static Engine toEngine(com.chaoqwq.gbt32960.message.Engine source) {
    ...
    public static FuelCell toFuelCell(com.chaoqwq.gbt32960.message.FuelCell source) {
